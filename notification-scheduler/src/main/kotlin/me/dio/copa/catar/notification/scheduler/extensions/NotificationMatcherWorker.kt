...
val NOTIFICATION_TITLE_KEY = "NOTIFICATION_TITLE_KEY"
val NOTIFICATION_CONTENT_KEY = "NOTIFICATION_CONTENT_KEY"

class NotificationMatcherWorker(private val context: Context, workParameters: WorkerParameters) :
    ...
    override fun doWork(): Result {
        ...
        val content = inputData.getString(NOTIFICATION_CONTENT_KEY)
            ?: throw IllegalArgumentException("content is required is required")

        context.showNotification(title = title, content = content)
